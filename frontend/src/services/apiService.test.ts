...
describe('ApiService', () => {
  ...
  describe('submitRequest', () => {
    ...
    it('should handle HTTP error responses', async () => {
      ...
      await expect(ApiService.submitRequest(mockRequestData)).rejects.toThrow('Server error');
    });
    ...
    it('should handle HTTP error without errMsg in response', async () => {
      ...
      await expect(ApiService.submitRequest(mockRequestData)).rejects.toThrow('HTTP error! status: 404');
    });
    ...
    it('should handle JSON parsing errors in error response', async () => {
      ...
      await expect(ApiService.submitRequest(mockRequestData)).rejects.toThrow('HTTP error! status: 500');
    });
  ...
  describe('getRequestsForRequestor', () => {
    it('should fetch requests for requestor successfully', async () => {
      ...
      const result = await ApiService.getRequestsForRequestor('test@example.com');
  ...
  describe('getPendingRequests', () => {
    it('should fetch pending requests successfully', async () => {
      ...
      const result = await ApiService.getPendingRequests('approver@example.com');
  ...
  describe('getAuthHeaders', () => {
    ...
    it('should work in bypass auth mode', async () => {
      ...
      vi.mocked(AuthService.getStoredToken).mockReturnValue('mock-bypass-token');
